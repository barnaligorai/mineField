...
# echo '{"path":[3,13,23,33,34,35,36,46,56,57,67,77,87,86,96],"row":10,"col":10, "pos":-7, "choices":[]}' > mineField.json
echo '{"path":[2,5,6,9,6],"row":3,"col":3, "pos":-1, "choices":[]}' > mineField.json
